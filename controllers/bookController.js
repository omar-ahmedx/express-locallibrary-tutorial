  ...
  async.parallel(
    ...
    function (err, results) {
      res.render("index", {
        ...
        error: err,
        data: results,
      }); //he callback function from async.parallel() above is a little unusual in that we render the page whether or not there was an error (normally you might use a separate execution path for handling the display of errors).
    }
  );
};
